...
python3.5 custom_env_5.py #fourth experiment
...
=== Четвертый эксперимент.   (python3.5 custom_env_5.py)
Внутри del6/experience находится image.png, к которому агент стремится.
Агент рисует штрихами скетч.
Награждается после каждого штриха за уменьшение несоответствия с целевым рисунком image.png
И награждается после 45 штрихов оператором на усмотрение оператора.
Так же, как во втором эксперименте, возможно погрузить в сон клавишей s, вывести клавишей w, поставить из сна на паузу via c